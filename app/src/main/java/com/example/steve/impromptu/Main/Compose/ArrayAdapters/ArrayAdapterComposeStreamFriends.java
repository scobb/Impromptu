 ...
 */
public class ArrayAdapterComposeStreamFriends extends ArrayAdapter<ImpromptuUser> {

    private ArrayList<ImpromptuUser> friendList;
    private ArrayList<Group> groupsList;
    private Context context;

    public ArrayAdapterComposeStreamFriends(Context context, int textViewResourceId,
